...
namespace ContosoSuitesWebAPI.Plugins
{
    ...
    public class MaintenanceRequestPlugin(CosmosClient cosmosClient)
    {
        ...
        public async Task<MaintenanceRequest> CreateMaintenanceRequest(
            Kernel kernel, int HotelId, string Hotel, string Details, int? RoomNumber, string? location)
        {
            try
            {
        ...
        public async Task SaveMaintenanceRequest(
            Kernel kernel, MaintenanceRequest maintenanceRequest)
        {
