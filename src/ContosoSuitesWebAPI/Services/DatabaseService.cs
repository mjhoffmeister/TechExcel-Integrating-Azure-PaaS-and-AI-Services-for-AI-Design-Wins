...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId,
        [Description("The date after which bookings should be retrieved")] DateTime dt)
    {
    ...
    [Description("Get bookings that don't have associated hotel rooms.")]
    ...
    [Description("Get bookings that have multiple associated hotel rooms.")]
